...
export default function Home({ globalSettings, homePage }) {
  return (
    <>
      <Head>
        <title>
          {globalSettings?.siteName || 'Fortolker'} - Rådgivning innen innovasjon, teknologi og ledelse
        </title>
        <meta
          name="description"
            ...
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                {homePage?.heroSubheading ||
                  'Vi hjelper organisasjoner med å navigere i en verden i rask teknologisk endring.'}
              </p>
              <Link
                href="/kontakt"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">
              {homePage?.introHeading || 'Det handler om folk'}
            </h2>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {homePage?.featuredServices?.map((service) => (
              <Link key={service.slug.current} href={`/tjenester#${service.slug.current}`}>
